...
abstract class VerifyRomToolsTask : DefaultTask() {
     ...
     *
     * Checks the task's `romToolsDir` directory property. If the directory is missing, logs a warning indicating
     * ROM functionality may be limited; if present, logs a lifecycle message with the directory's absolute path.
     */
    @TaskAction
    fun verify() {
